...
public class CustomServer {
    private Map<String, HeroServlet> servletMap = new HashMap<>();
    ...
    public void start() throws Exception {
        ...
        while (true){
            ...
            CustomHandler customHandler = new CustomHandler(socket,servletMap);
            threadPoolExecutor.execute(customHandler);
        }
    }
